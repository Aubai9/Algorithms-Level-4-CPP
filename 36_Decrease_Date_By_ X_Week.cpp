...
stDate Decrease_Date_By_X_Week(stDate  date,short Decreased_Weeks)
{
    for(short i = Decreased_Weeks * 7; i  >= 1; i--)
        {
...
int main()
{
    ...
    cout<<"Subtracting date by X week\n";

    cout<<"Enter how many weeks do you want to decrease: ";

    cin >> Decreased_Weeks;

    Date_After_Subtracting = Decrease_Date_By_X_Week(date,Decreased_Weeks);
