...
stDate Increase_Date_by_X_Week(stDate  date,short Added_Week)
{
    for(short i = 1; i<= Added_Week * 7; i++)
        {
...
int main()
{
    ...
    cout<<"enter how many weeks do you want to add: ";

    cin>> Added_Week;

    Date_After_Addition =  Increase_Date_by_X_Week(date,Added_Week);
