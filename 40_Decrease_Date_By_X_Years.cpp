...
stDate Decrease_Date_By_X_Years(stDate date,short Decreased_Years)
{
    for(int i = Decreased_Years; i >= 1 ; i--)
        {
...
int main()
{
    ...
    Date_After_Subtracting = Decrease_Date_By_X_Years(date,Decreased_Years);
