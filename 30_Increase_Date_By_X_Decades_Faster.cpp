...
stDate Increase_Date_By_X_Years_Faster(stDate date,short Added_Decades)
{
    date.year += (Added_Decades * 10);
...
int main()
{
    ...
    cout<<"Increase date by X Decade/s\n";

    cout<<"enter how many Decade/s do you want to add: ";

    cin>> Added_Decades;

    Date_After_Addition = Increase_Date_By_X_Years_Faster(date,Added_Decades);
