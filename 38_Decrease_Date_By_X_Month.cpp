...
stDate Decrease_Date_By_X_Month(stDate  date,short Decreased_Months)
{

    for(int i = Decreased_Months; i >= 1 ; i-- )
        {
...
int main()
{
    ...
    cout<<"Subtracting date by X month\n";

    cout<<"Enter how many Months do you want to decrease: ";

    cin>>Decreased_Months;

    Date_After_Subtracting = Decrease_Date_By_X_Month(date, Decreased_Months);
