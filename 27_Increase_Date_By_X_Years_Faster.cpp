...
stDate Increase_Date_By_X_Years_Faster(stDate date,short Added_Years)
{
    date.year += Added_Years;
...
int main()
{
    ...
    cout<<"enter how many Year/s do you want to add: ";

    cin>> Added_Years;

    Date_After_Addition = Increase_Date_By_X_Years_Faster(date,Added_Years);
